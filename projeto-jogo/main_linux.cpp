...
#define VELOCIDADE 4 //recomendamos aumentar de 0.1 em 0.1 até encontrar o valor ideal

//!Essa constante define as proporções da tela
#define TAMANHO_TELA 1.2 //recomendamos aumentar para valores entre 1 e 2
